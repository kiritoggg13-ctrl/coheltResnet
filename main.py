...
HF_API_URL = "https://geryuga230123-cohelt.hf.space/predict"
...
DESCRIPTIONS = {
    ...
    "healthy": {
        ...
        "penanganan": ["Lanjutkan perawatan rutin.", "Jaga sanitasi kebun."],
    },
    "pod_borer": {
        "nama": "Pod Borer (PBK)",
        "deskripsi": "Hama penggerek buah kakao.",
        "penanganan": ["Panen tepat waktu.", "Gunakan perangkap feromon."],
    },
    "unknown": {
    ...
    try:
        ...
        if confidence is not None and isinstance(confidence, (int, float)):
            if float(confidence) < CONFIDENCE_THRESHOLD:
                return JSONResponse(
                    {"class": "unknown", "details": DESCRIPTIONS["unknown"]}
                )
